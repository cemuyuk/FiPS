...
from sd2s.lr import LRLayer, LRModel
...
@hydra.main(
    ...
    config_name="gemma_2_2b_config_local_lr_1",
    version_base="1.3",
)
...
def _get_compressed_model(
    ...
    # c_model = SMMLodel(cfg.model.kwargs, model)
    c_model = LRModel(cfg.model.kwargs, model)
    return c_model
